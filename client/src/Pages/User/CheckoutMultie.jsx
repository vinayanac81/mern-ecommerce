...
export const CheckoutMultie = () => {
  ...
  const getInitialData = async () => {
    try {
      ...
      if (cartData?.data?.success) {
        setcart(cartData?.data?.cartProducts);
        const total = cartData?.data.cartProducts.reduce(
          (acc, curr) =>
  ...
  return (
    <div>
      <Header />
      <div  style={{ backgroundColor: "#f0f0f0" }} className=" pt-6 px-5 pb-10  md:px-40">
                      ...
                      <div className="  bg-white ">
                        {cart.map((item, index) => {
                          return (
                            <div
                              key={index}
                              className="flex px-10 py-4 border-b-2 pb-8"
                            >
                              ...
                              <div className="w-[60%] px-5">
                                ...
                                <div className="flex mt-2 gap-5 text-slate-600">
                                  <h2>{item?.product?.ram}</h2>
                                  <h2>{item?.product?.rom}</h2>
                                </div>
