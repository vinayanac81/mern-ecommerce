...
const OrderViewPage = () => {
  ...
  const getOrderDetails = async () => {
    try {
      setloading(true);
      const { data } = await AxiosInstance.get("/admin/get-order-details", {
        params: { orderId: id },
      });
      console.log(data);
      setloading(false);
              ...
              <div className="md:w-[40%] w-[90%] mb-4 md:mb-0 ">
                <Card className="max-w-md">
                  ...
                  <div className="flex flex-col items-center ">
                    ...
                    <h5 className="mb-1 uppercase text-sm font-medium text-gray-900 dark:text-white">
                     Number : {userData.mobile===undefined?"not available":userData.mobile}
                    </h5>
                    <h5 className="mb-1 uppercase  text-sm font-medium text-gray-900 dark:text-white">
                      {userData.email}
                    </h5>
                    ...
                    <div className="mt-4 flex space-x-3 md:mt-0">
                      <a className="inline-flex items-center rounded-lg bg-cyan-700 px-4 py-2 text-center text-sm font-medium text-white hover:bg-cyan-800 focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800">
                        Block
                      </a>
                      <a
                        href="/admin/orders"
